    ...
    android.apply {
        ...
        buildTypes {
            getByName("release") {
                ...
                // Opt: enable R8 full mode — allows more aggressive dead-code elimination,
                // class merging, and field/method inlining that the default "compat" mode
                // skips for backwards compatibility. Safe for this project because we control
                // the keep rules precisely.
                proguardFiles(getDefaultProguardFile("proguard-android-optimize.txt"))
            }
        }
        // Opt: target Java 11 (previously 1.8). The Android Gradle Plugin + R8 use the
        // target level to enable additional bytecode optimizations (e.g., invokedynamic
        // for lambdas, string concatenation intrinsics). minSdk 21 is fine with desugaring.
        compileOptions {
        ...
        (android as ExtensionAware).extensions.getByName<KotlinJvmOptions>("kotlinOptions").apply {
            ...
            // Opt: enable Kotlin IR backend optimizations
            freeCompilerArgs = freeCompilerArgs + listOf(
                "-opt-in=kotlin.RequiresOptIn",
                "-Xjvm-default=all",          // emit default interface methods directly
            )
        }
        lint {
            showAll = true
        ...
        packaging {
            resources.excludes.addAll(
                listOf(
                    ...
                    "**/*.proto",
                    "okhttp3/**",
                    // Opt: additional exclusions that shave APK size
                    "**/*.txt",
                    "**/*.xml",
                    "META-INF/NOTICE*",
                    "META-INF/LICENSE*",
